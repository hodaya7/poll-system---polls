...
public class QuestionWithAnswerCounts {
    private Long id;
    ...
    // Constructors
    public QuestionWithAnswerCounts() {}

    public QuestionWithAnswerCounts(Long id, String title, String firstAnswer, String secondAnswer, String thirdAnswer, String fourthAnswer) {
        this.id = id;
        this.title = title;
